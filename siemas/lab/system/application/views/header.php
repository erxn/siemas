                ...
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <ul id="nav">
                            ...
                            <li id="<?php if(($this->uri->segment(1)== "registrasi")||($this->uri->segment(2)=="registrasi_pasien_sukses")) echo "current"?>"><a href="index.php/registrasi">Antrian</a></li>
                            <li id="<?php if($this->uri->segment(1)== "pembayaran") echo "current"?>"><a href="index.php/pembayaran">Pemeriksaan</a></li>
