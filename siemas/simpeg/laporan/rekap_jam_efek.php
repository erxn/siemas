        ...
        <div class="module">
            ...
            <div class="module-table-body">
                <table width="100%">
                    <thead>
                        <tr>
                            <th colspan="<?php echo $jumlah_hari_bulan_ini + 4 ?>"><h4>Puskesmas Bogor Tengah</h4></th>
                        </tr>
                        <tr>
                            ...
                            <th style="width: 18px">Jumlah</th>
                            <th style="width: 18px">Rataan</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <thead>
                        <tr>
                            <th colspan="<?php echo $jumlah_hari_bulan_ini + 4 ?>"><h4>BP Pemda</h4></th>
                        </tr>
                        <tr>
                            <th style="width: 10px;">No</th>
                            <th style="width: 150px">Nama</th>
