...
<form action="index.php/pegawai/edit_pegawai/<?php echo $data_pegawai['id_pegawai'] ?>" method="post">
    <div class="belowribbon">
        <h1>
            Data pegawai baru
            <input type="submit" class="submit-green" value="Edit data" style="margin-left: 10px" name="get"/>
        </h1>
    </div>
</form>
   ...
   <div id="page">
        <div class="grid_6" style="width: 48%">
            ...
            <div class="notification n-success">
                Data pegawai baru telah ditambahkan
            </div>
                    ...
                    <table border="0" id="tabel_tanggungan">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><strong><?php if($data['dapat_tunjangan'] == "1") echo "Ya"; else echo "Tidak" ?></strong></td>
                    ...
                    <table width="100%" class="noborder">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong><?php if($data_pegawai['bp_pemda'] == "1") echo "Ya"; else echo "Tidak" ?></strong></td>
                            </tr>
                            <tr>
                    ...
                    <table width="100%" class="noborder">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><strong><?php $p = $this->pegawai->get_pegawai_by_id($data_pegawai['id_atasan']); echo $p['nama']; ?></strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
