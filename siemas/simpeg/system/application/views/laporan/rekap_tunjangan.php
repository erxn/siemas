...
<div class="belowribbon">
    <h1>
        ...
        <a href="index.php/penilaian/rekap_tunjangan_xls/<?php echo $bulan ?>/<?php echo $tahun ?>" class="submit-green xls-button" style="margin-left: 10px" title="Simpan sebagai file Excel">
