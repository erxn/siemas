...
<script type="text/javascript">
    function load_tabel_antri() {
        $('#div-antri').load("index.php/<?php echo $myself ?>/tabel_antri");
    }

    function load_tabel_diperiksa() {
        $('#div-diperiksa').load("index.php/<?php echo $myself ?>/tabel_diperiksa");
    }

    function load_tabel_tunda() {
        $('#div-tunda').load("index.php/<?php echo $myself ?>/tabel_tunda");
    }
    
    function load_tabel_selesai() {
        $('#div-selesai').load("index.php/<?php echo $myself ?>/tabel_selesai");
    }
...
function periksa(id) {
    ...
    $.get('index.php/<?php echo $myself ?>/periksa/' + id);
    load_tabel_antri();
    load_tabel_diperiksa();
    load_tabel_tunda();
...
function lewati(id) {
    ...
    $.get('index.php/<?php echo $myself ?>/lewati/' + id);
    load_tabel_antri();
    load_tabel_diperiksa();
    load_tabel_tunda();
...
function selesai(id) {
    ...
    $.get('index.php/<?php echo $myself ?>/selesai/' + id);
    load_tabel_antri();
    load_tabel_diperiksa();
    load_tabel_tunda();
