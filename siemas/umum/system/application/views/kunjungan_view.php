...
<!-- END SUBNAV -->
    <div>
        <div class="grid_6" style="width: 98%">
            ...
            <h4 align="right">Total Pasien: <?php echo count($kunjungan);?> orang</h4>
<table style="width: 99%" >
                <thead>
                    <tr>
                        ...
                        <th style="width:6%">Diagnosa</th>
                   </tr>
                </thead>
                <tbody>
                    <?php $i=1; if(isset($kunjungan)) { foreach ($kunjungan as $k) {?>
                    <tr class="<?php if($i%2==0) echo "odd"; else echo "even";?>">
                       ...
                       <td><?php echo $k['no_kunjungan'];?></td>
                        ...
                        <td><?php echo $k['nama_penyakit']?></td>
                        <td><?php echo $k['diagnosa']?></td>
                    </tr>
                    <?php }}else { ?>
                            <tr>
                                <td></td>
