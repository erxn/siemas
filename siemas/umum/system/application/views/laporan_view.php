        ...
        <div  class="tabs">
            ...
            <div id="tabs-1">
                ...
                <table>
                    <tr>
                        <td>
                            <a style="text-decoration: none" href="index.php/laporan/lap_hp" class="dashboard-module">
                        ...
                        <td>
                            <a  style="text-decoration: none"  href="index.php/laporan/lap_ht" class="dashboard-module">
            ...
            <div  class="tabs">
                ...
                <div id="tabs-2">
                    ...
                    <table>
                        <tr>
                            <td>
                                <a style="text-decoration: none"  href="#" class="dashboard-module">
