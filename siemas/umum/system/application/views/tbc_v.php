                    ...
                    <table  id="myTable"  class="noborder" style="width:100%">
                        <tr class="odd">
                         ...
                         <tr>
                            ...
                            <td><textarea name="n_hasil_periksa" rows="5" cols="40"></textarea></td>
                        </tr>
                         <tr class="odd">
                            <td>Rejimen:</td>
                            <td><textarea name="n_rejimen" rows="5" cols="40"></textarea></td>
                        </tr>
                        <tr>
                        ...
                        <tr> <td></td>
                            <td>
                                ...
                                <a href="http://localhost/siemas/umum/index.php/antrian/isi_remed_hari_ini/<?php echo $selesai[$i]['id_pasien'];?>/<?php echo $selesai[$i]['id_kunjungan'];?>/<?php echo $selesai[$i]['id_antrian']?>"> <input name="submit"  type="submit" class="submit-green" value="Simpan" /></a>
