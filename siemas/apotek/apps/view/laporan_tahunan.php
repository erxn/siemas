...
<div><div>
        <div class="container_12">
            <div style="border: 0px solid fuchsia; width: 777px; height: auto;padding: 8px; ">
                <a href="#" class="kotak" style="color:#000;"><img src="<?php echo $this->base_url ?>Template_files/loket_pen.png" border="0"/> Laporan Tahunan</a>
                <div class="module" style="width: 390px ; float:right;">
                    <h2><span>Pilih bulan sebagai awal tahun!</span></h2>
                    ...
                    <div class="module-table-body">
                        <form method="post"
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <select name="bulan" id="bulan" style="width:103px;">
                                    ...
                                    <td>-</td>
                                    <td>
                                        <select name="tahun" id="tahun" style="width:103px;">
