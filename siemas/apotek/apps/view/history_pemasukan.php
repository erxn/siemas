    ...
    <div class="container_12">
        <div class="grid_12">
            <ul style="margin-left: 50px;">
                ...
                <li id="current"><a href="<?php echo $this->base_url ?>index.php/riwayat/tambah_obat">Penambahan Obat</a></li>
...
<div class="container_12">
    <div style="border: 0px solid fuchsia; width: 777px; height: auto;padding: 8px; ">
        <a href="<?php echo $this->base_url ?>index.php/riwayat/resep" class="kotak" style="color:#000;"><img src="<?php echo $this->base_url ?>Template_files/loket_pen.png" border="0"/> Riwayat Penambahan Obat</a>
