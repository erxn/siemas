...
<!-- END SUBNAV -->
<div style="font-size: 14px !important;padding: 4px; margin-left: 10px;"><a href="index.php/c_laporan">Laporan</a> > <a href="index.php/c_laporan/rekapitulasi_kunjungan">Rekapitulasi Kunjungan</a> > Pasien Jamkesmas</div>
<!--<div style="font-size: 14px !important;padding: 2px; margin-left: 15px;"><a href="index.php/c_laporan">Laporan</a> > Rekapitulasi Kunjungan</div>-->
    <div>
        <div class="grid_6" style="width: 98%">
            ...
            <br/>
            <hr/>
            <h3 align="right">Total Pasien: <?php echo count($jam);?> orang</h3>
<table style="width: 99%" >
                ...
                <tbody>
                    <?php $i=1; if(isset($jam)) { foreach ($jam as $hasil) {?>
                    <tr class="<?if($i%2==0) echo "odd"; else echo "even";?>">
                        <td class="align-center"><?php echo $i++; ?></td>
                        <td><?php echo $hasil['kode_pasien']?></td>
                        <td class="align-center"><?php echo $hasil['no_kunjungan'];?></td>
