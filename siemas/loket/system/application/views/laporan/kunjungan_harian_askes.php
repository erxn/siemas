...
<!-- END SUBNAV -->
<div style="font-size: 14px !important;padding: 4px; margin-left: 10px;"><a href="index.php/c_laporan">Laporan</a> > <a href="index.php/c_laporan/rekapitulasi_kunjungan">Kunjungan Harian</a> > Pasien Askes</div>
<!--<div style="font-size: 14px !important;padding: 2px; margin-left: 15px;"><a href="index.php/c_laporan">Laporan</a> > Rekapitulasi Kunjungan</div>-->
    <div>
        <div class="grid_6" style="width: 98%">
            ...
            <br/>
            <div align="right" style="font-size: 14px !important"><a href="index.php/c_laporan/rekap_kunjungan_askes">Lihat Rekapan >></a></div>
            <hr/>
            
            <h4 align="right">Total Pasien: <?php echo count($askes);?> orang</h4>
