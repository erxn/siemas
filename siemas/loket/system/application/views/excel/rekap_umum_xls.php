...
$xls->getActiveSheet()->setCellValue("B$i","=SUM(B9:B39)");
$xls->getActiveSheet()->setCellValue("C$i","=SUM(C9:C39)");
$xls->getActiveSheet()->setCellValue("D$i","=SUM(D9:D39)");
$xls->getActiveSheet()->setCellValue("E$i","=SUM(E9:E39)");
$xls->getActiveSheet()->setCellValue("F$i","=SUM(F9:F39)");
$xls->getActiveSheet()->setCellValue("G$i","=SUM(G9:G39)");
$xls->getActiveSheet()->setCellValue("H$i","=SUM(H9:H39)");
$xls->getActiveSheet()->setCellValue("I$i","=SUM(I9:I39)");
$xls->getActiveSheet()->setCellValue("J$i","=SUM(J9:J39)");
$xls->getActiveSheet()->setCellValue("K$i","=SUM(K9:K39)");
$xls->getActiveSheet()->setCellValue("L$i","=SUM(L9:L39)");
$xls->getActiveSheet()->setCellValue("M$i","=SUM(M9:M39)");
$xls->getActiveSheet()->setCellValue("N$i","=SUM(N9:N39)");
$xls->getActiveSheet()->setCellValue("O$i","=SUM(O9:O39)");
$xls->getActiveSheet()->setCellValue("P$i","=SUM(P9:P39)");
$xls->getActiveSheet()->setCellValue("Q$i","=SUM(Q9:Q39)");
$xls->getActiveSheet()->setCellValue("R$i","=SUM(R9:R39)");
$xls->getActiveSheet()->setCellValue("S$i","=SUM(S9:S39)");
$xls->getActiveSheet()->setCellValue("T$i","=SUM(T9:T39)");
$xls->getActiveSheet()->setCellValue("U$i","=SUM(U9:U39)");
$xls->getActiveSheet()->setCellValue("V$i","=SUM(V9:V39)");
$xls->getActiveSheet()->setCellValue("W$i","=SUM(W9:W39)");
$xls->getActiveSheet()->setCellValue("X$i","=SUM(X9:X39)");
$xls->getActiveSheet()->setCellValue("Y$i","=SUM(Y9:Y39)");
$xls->getActiveSheet()->setCellValue("Z$i","=SUM(Z9:Z39)");
// output it
