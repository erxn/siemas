...
class Laporan extends Controller{
   ...
   function lb4($bln,$thn){
       ...
       $data['pab_a_anak_lama']=0;
       $data['pab_a_anak_baru']=0;
       $data['pab_a_hamil_lama']=0;
       $data['pab_a_hamil_baru']=0;
       $data['pab_j_anak_lama']=0;
       $data['pab_j_anak_baru']=0;
       $data['pab_j_hamil_lama']=0;
       $data['pab_j_hamil_baru']=0;
       $data['pab_u_anak_lama']=0;
       $data['pab_u_anak_baru']=0;
       $data['pab_u_hamil_lama']=0;
       $data['pab_u_hamil_baru']=0;
       $data['cib_a_anak_lama']=0;
       $data['cib_a_anak_baru']=0;
       $data['cib_a_hamil_lama']=0;
       $data['cib_a_hamil_baru']=0;
       $data['cib_j_anak_lama']=0;
       $data['cib_j_anak_baru']=0;
       $data['cib_j_hamil_lama']=0;
       $data['cib_j_hamil_baru']=0;
       $data['cib_u_anak_lama']=0;
       $data['cib_u_anak_baru']=0;
       $data['cib_u_hamil_lama']=0;
       $data['cib_u_hamil_baru']=0;
       $data['lw_a_anak_lama']=0;
       $data['lw_a_anak_baru']=0;
       $data['lw_a_hamil_lama']=0;
       $data['lw_a_hamil_baru']=0;
       $data['lw_j_anak_lama']=0;
       $data['lw_j_anak_baru']=0;
       $data['lw_j_hamil_lama']=0;
       $data['lw_j_hamil_baru']=0;
       $data['lw_u_anak_lama']=0;
       $data['lw_u_anak_baru']=0;
       $data['lw_u_hamil_lama']=0;
       $data['lw_u_hamil_baru']=0;
       $data['lk_a_anak_lama']=0;
       $data['lk_a_anak_baru']=0;
       $data['lk_a_hamil_lama']=0;
       $data['lk_a_hamil_baru']=0;
       $data['lk_j_anak_lama']=0;

       $data['lk_j_anak_baru']=0;
       $data['lk_j_hamil_lama']=0;
       $data['lk_j_hamil_baru']=0;
       $data['lk_u_anak_lama']=0;
       $data['lk_u_anak_baru']=0;
       $data['lk_u_hamil_lama']=0;
       $data['lk_u_hamil_baru']=0;
       $data['p_a_kunj_baru']=0;
       $data['p_j_kunj_baru']=0;
       $data['p_u_kunj_baru']=0;
       $data['c_a_kunj_baru']=0;
       $data['c_j_kunj_baru']=0;
       $data['c_u_kunj_baru']=0;
       $data['lw_a_kunj_baru']=0;
       $data['lw_j_kunj_baru']=0;
       $data['lw_u_kunj_baru']=0;
       $data['lk_a_kunj_baru']=0;
       $data['lk_j_kunj_baru']=0;
       $data['lk_u_kunj_baru']=0;
       $data['p_a_kunj_lama']=0;
       $data['p_j_kunj_lama']=0;
       $data['p_u_kunj_lama']=0;
       $data['c_a_kunj_lama']=0;
       $data['c_j_kunj_lama']=0;
       $data['c_u_kunj_lama']=0;
       $data['lw_a_kunj_lama']=0;
       $data['lw_j_kunj_lama']=0;
       $data['lw_u_kunj_lama']=0;
       $data['lk_a_kunj_lama']=0;
       $data['lk_j_kunj_lama']=0;
       $data['lk_u_kunj_lama']=0;
       ...
       $data['lk_j_pulpa']=0;
       $data['lk_u_pulpa']=0;
       $data['p_a_periodontal']=0;
       $data['p_j_periodontal']=0;
       $data['p_u_periodontal']=0;
       $data['c_a_periodontal']=0;
       $data['c_j_periodontal']=0;
       $data['c_u_periodontal']=0;
       $data['lw_a_periodontal']=0;
       $data['lw_j_periodontal']=0;
       $data['lw_u_periodontal']=0;
       $data['lk_a_periodontal']=0;
       $data['lk_j_periodontal']=0;
       $data['lk_u_periodontal']=0;
       $data['p_a_dentofasial']=0;
       $data['p_j_dentofasial']=0;
       $data['p_u_dentofasial']=0;
       $data['c_a_dentofasial']=0;
       $data['c_j_dentofasial']=0;
       $data['c_u_dentofasial']=0;
       $data['lw_a_dentofasial']=0;
       $data['lw_j_dentofasial']=0;
       $data['lw_u_dentofasial']=0;
       $data['lk_a_dentofasial']=0;
       $data['lk_j_dentofasial']=0;
       $data['lk_u_dentofasial']=0;
       $data['p_a_gangguan_gusi']=0;
       $data['p_j_gangguan_gusi']=0;
       $data['p_u_gangguan_gusi']=0;
       $data['c_a_gangguan_gusi']=0;
       $data['c_j_gangguan_gusi']=0;
       $data['c_u_gangguan_gusi']=0;
       $data['lw_a_gangguan_gusi']=0;
       $data['lw_j_gangguan_gusi']=0;
       $data['lw_u_gangguan_gusi']=0;
       $data['lk_a_gangguan_gusi']=0;
       $data['lk_j_gangguan_gusi']=0;
       $data['lk_u_gangguan_gusi']=0;
       $data['p_a_tumpatan_tetap']=0;
       $data['p_j_tumpatan_tetap']=0;
       $data['p_u_tumpatan_tetap']=0;
       $data['c_a_tumpatan_tetap']=0;
       $data['c_j_tumpatan_tetap']=0;
       $data['c_u_tumpatan_tetap']=0;
       $data['lw_a_tumpatan_tetap']=0;
       $data['lw_j_tumpatan_tetap']=0;
       $data['lw_u_tumpatan_tetap']=0;
       $data['lk_a_tumpatan_tetap']=0;
       $data['lk_j_tumpatan_tetap']=0;
       $data['lk_u_tumpatan_tetap']=0;
       $data['p_a_pencabutan_tetap']=0;
       $data['p_j_pencabutan_tetap']=0;
       $data['p_u_pencabutan_tetap']=0;
       $data['c_a_pencabutan_tetap']=0;
       $data['c_j_pencabutan_tetap']=0;
       $data['c_u_pencabutan_tetap']=0;
       $data['lw_a_pencabutan_tetap']=0;
       $data['lw_j_pencabutan_tetap']=0;
       $data['lw_u_pencabutan_tetap']=0;
       $data['lk_a_pencabutan_tetap']=0;
       $data['lk_j_pencabutan_tetap']=0;
       $data['lk_u_pencabutan_tetap']=0;
       $data['p_a_tumpatan_sulung']=0;
       $data['p_j_tumpatan_sulung']=0;
       $data['p_u_tumpatan_sulung']=0;
       $data['c_a_tumpatan_sulung']=0;
       $data['c_j_tumpatan_sulung']=0;
       $data['c_u_tumpatan_sulung']=0;
       $data['lw_a_tumpatan_sulung']=0;
       $data['lw_j_tumpatan_sulung']=0;
       $data['lw_u_tumpatan_sulung']=0;
       $data['lk_a_tumpatan_sulung']=0;
       $data['lk_j_tumpatan_sulung']=0;
       $data['lk_u_tumpatan_sulung']=0;
       $data['p_a_pencabutan_sulung']=0;
       $data['p_j_pencabutan_sulung']=0;
       $data['p_u_pencabutan_sulung']=0;
       $data['c_a_pencabutan_sulung']=0;
       $data['c_j_pencabutan_sulung']=0;
       $data['c_u_pencabutan_sulung']=0;
       $data['lw_a_pencabutan_sulung']=0;
       $data['lw_j_pencabutan_sulung']=0;
       $data['lw_u_pencabutan_sulung']=0;
       $data['lk_a_pencabutan_sulung']=0;
       $data['lk_j_pencabutan_sulung']=0;
       $data['lk_u_pencabutan_sulung']=0;
       $data['p_a_pulpa_periapikal']=0;
       $data['p_j_pulpa_periapikal']=0;
       $data['p_u_pulpa_periapikal']=0;
       $data['c_a_pulpa_periapikal']=0;
       $data['lw_a_pulpa_periapikal']=0;
       $data['lw_j_pulpa_periapikal']=0;
       $data['lw_u_pulpa_periapikal']=0;
       $data['c_j_pulpa_periapikal']=0;
       $data['c_u_pulpa_periapikal']=0;
      
       $data['lk_a_pulpa_periapikal']=0;
       $data['lk_j_pulpa_periapikal']=0;
       $data['lk_u_pulpa_periapikal']=0;
       $data['p_a_gusi_periodontal']=0;
       $data['p_j_gusi_periodontal']=0;
       $data['p_u_gusi_periodontal']=0;
       $data['c_a_gusi_periodontal']=0;
       $data['c_j_gusi_periodontal']=0;
       $data['c_u_gusi_periodontal']=0;
       $data['lw_a_gusi_periodontal']=0;
       $data['lw_j_gusi_periodontal']=0;
       $data['lw_u_gusi_periodontal']=0;
       $data['lk_a_gusi_periodontal']=0;
       $data['lk_j_gusi_periodontal']=0;
       $data['lk_u_gusi_periodontal']=0;
       $data['p_a_karang_gigi']=0;
       $data['p_j_karang_gigi']=0;
       $data['p_u_karang_gigi']=0;
       $data['c_a_karang_gigi']=0;
       $data['c_j_karang_gigi']=0;
       $data['c_u_karang_gigi']=0;
       $data['lw_a_karang_gigi']=0;
       $data['lw_j_karang_gigi']=0;
       $data['lw_u_karang_gigi']=0;
       $data['lk_a_karang_gigi']=0;
       $data['lk_j_karang_gigi']=0;
       $data['lk_u_karang_gigi']=0;
