    ...
    <div class="module">
        ...
        <div class="module-body">
            <form name="cari_data_pasien" method="post" action="index.php/pasien/cari_pasien">
                <table class="noborder" style="width: 60%">
                    <tr>
                        <td>No. Index</td>
                        <td>:</td>
                        <td><input name="kode_pasien" type="text" class="input-long" placeholder="ID Pasien"/></td>
                        <td>&nbsp;</td>
                        <td>Alamat</td>
                        <td>:</td>
                        <td><input name="alamat" type="text" class="input-long" placeholder="Alamat Pasien"/></td>
                    </tr>
                    <tr>
                        <td>Nama</td>
                        <td>:</td>
                        <td><input name="nama_pasien" type="text" class="input-long" placeholder="Nama Pasien" id="nama-autocomplete"/></td>
                        <td>&nbsp;</td>
                        <td>Umur</td>
                        <td>:</td>
                        <td><input name="umur_pasien" type="text" class="input-long" placeholder="Umur Pasien"/></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
            ...
            <table style="width: 99%">
                ...
                <tbody>
                    ...
                    <tr class="<?php if($i%2==0) echo "odd"; else echo "even"; ?> ">
                        ...
                        <td><a class="popup" href=""><?php echo $hasil['nama_kk'];?></a></td>
                        <td><a class="popup" href=""><?php echo $hasil['nama_pasien'];?></a></td>
