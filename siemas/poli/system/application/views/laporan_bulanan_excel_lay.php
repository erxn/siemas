 ...
 */
        ...
        $objPHPExcel->getActiveSheet()
         ...
         for($n=1;$n<=10;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+8, $n);}
        for($n=1;$n<=19;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+20, $n);}
