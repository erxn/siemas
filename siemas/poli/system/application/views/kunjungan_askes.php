...
<!-- END SUBNAV -->
    <div>
        <div class="grid_6" style="width: 98%">
            ...
            <h4 align="right">Total Pasien: <?php echo count($kunj_askes);?> orang</h4>
<table style="width: 99%" >
                ...
                <tbody>
                    <?php $i=1; if(isset($kunj_askes)) { foreach ($kunj_askes as $askes) {?>
                    <tr class="<?php if($i%2==0) echo "odd"; else echo "even";?>">
                       ...
                       <td><?php echo $askes['no_kunjungan'];?></td>
                        ...
                        <td><?php echo $askes['nama_layanan']?></td>
                        <td><?php echo $askes['harga']?></td>
                    </tr>
                    <?php }}else { ?>
                            <tr>
                                <td></td>
