 ...
 */
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A5:G150')->getFont()->setSize(9);
        ...
        $objPHPExcel->getActiveSheet()
                    ...
                    ->mergeCells('C5:E5')->setCellValueByColumnAndRow(2, 5, "Bulan")
                    ->mergeCells('F5:F6')->setCellValueByColumnAndRow(5, 5, "Jumlah")


                 ->setCellValueByColumnAndRow(2, 6, "Jul")
                 ->setCellValueByColumnAndRow(3, 6, "Agust")
                 ->setCellValueByColumnAndRow(4, 6, "Sept")
 ...
 ->setCellValueByColumnAndRow(0, 50, "V")
         ...
         for($n=1;$n<=11;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+7, $n);}
        for($n=1;$n<=5;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+20, $n);}
        for($n=1;$n<=9;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+27, $n);}
        for($n=1;$n<=10;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+38, $n);}
for($n=1;$n<=5;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+50, $n);}
for($n=6;$n<=9;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+53, $n);}
for($n=1;$n<=4;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+65, $n);}
for($n=1;$n<=7;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+71, $n);}
        for($n=1;$n<=3;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+87, $n);}
for($n=1;$n<=4;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+96, $n);}
for($n=1;$n<=8;$n++){$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $n+102, $n);}

$objPHPExcel->getActiveSheet()->getStyle('G6:N6')->applyFromArray($styleAlignHorizontalCenter);
        $objPHPExcel->getActiveSheet()->getStyle('A5:F110')->applyFromArray($styleAlignVerticalCenter);
         $objPHPExcel->getActiveSheet()->getStyle('A5:f110')->applyFromArray($styleThinBlackBorderAll);
