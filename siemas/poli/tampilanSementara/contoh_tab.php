	...
	$(function() {
		$( "#tabs" ).tabs();
						  ...
						  <ul id="">
                                ...
                                <li><a href="#"style="background:#3cb3db ">Lab</a></li>
			...
			dateFormat: 'dd-mm-yy'
                ...
                <div class="module" style=" margin-top: -5px; float: right; width: 48%">
                 ...
                 <ul id="nav" style="margin-top: -50px; margin-right:500px ; float:left;">
                                   <li id="current"><a href="#">Anamnesis</a></li>
                                <li style="background:#3cb3db " ><a href="remed_gigi_diagnosa.php" style="background: #3cb3db" >Diagnosa</a></li>
				<li style="background:#3cb3db " ><a href="#" style="background: #3cb3db" >Layanan</a></li>
                               ...
                               <li style="background:#3cb3db " ><a href="remed_gigi_ket.php" style="background: #3cb3db" >Keterangan</a></li>
