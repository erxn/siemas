                                    ...
                                    <div style="padding: 10px;">
                                        ...
                                        <input id="datepicker" placeholder="Masukkan tanggal" type="text" class="input-long" style="vertical-align: top; margin-top: 5px;">
                                            ...
                                            <img src="Template_files/cari.png">
                                                        ...
                                                        <table id="myTable" class="tablesorter">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a id="pop2" href="data_akhir_tabel.php">20-08-2009</a></td>
                                                                    <td>Sariawan</td>
                                                                    <td>Bolong gigi</td>
                                                ...
                                                <script type="text/javascript">
                                                    $(document).ready(function(){
                                                        $("#pop1").colorbox({initialHeight: "900px", initialWidth: "900px", width: "70%", height: "85%"})
                                                        $("#pop2").colorbox({initialHeight: "900px", initialWidth: "900px", width: "70%", height: "85%"})
                                                    });
                                                </script>
                                                ...
                                                <ul id="nav" style="margin-top: -50px; margin-right:500px ; float:left;">
                                                    ...
                                                    <li style="background:#3cb3db " ><a href="#" style="background: #3cb3db" >Layanan</a></li>
                                                    <li style="background:#3cb3db " ><a href="#" style="background: #3cb3db" >Resep Dokter</a></li>
                                                    <li  id="current"><a href="#">Keterangan</a></li>

                                                </ul>
                                                <div class="module" style=" margin-top: -20px;  margin-right:0%; float: left; width: 48%">			<!--buat nampilin yg poliiiii-->
                                                    <h2><span>Rekam Medik Pas</span></h2>
                                                            ...
                                                            <table class="noborder" style="width:100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="margin-rightt: 300px">
                                                                        <a id="pop1" href="data_akhir_diagnosis.php">
